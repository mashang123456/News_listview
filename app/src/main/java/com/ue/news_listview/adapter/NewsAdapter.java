package com.ue.news_listview.adapter;
...
import com.ue.news_listview.R;
import com.ue.news_listview.bean.NewsBean;
...
public class NewsAdapter extends BaseAdapter {
    ...
    //通过构造方法接受要显示的新闻数据集合，通过构造函数将形参传入到本类里面
    ...
    @Override
    public int getCount() {
        return list.size();//list有多大，界面就显示多少条
    }
